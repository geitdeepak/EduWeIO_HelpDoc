...
app_route: /
summary: Open a course demo from its card to watch a sample lesson and see the course chapters before you buy.
---
...
<figure markdown>
  ![The Demo button on a course card, outlined in red](../assets/images/home/home-12-demo-button.png){ loading=lazy }
...
<figure markdown>
  ![The course demo page. A red box outlines the Demo Course Preview badge above the course title. On the left are the course code PPS 1101 and a list of chapters. The top bar has Videos, Notes, Tutorials, MCQs, CBSQs, SEQs, Labs and Projects. The main area shows the course description, three tags, the instructor, and a Video Learning Preview panel](../assets/images/demo/demo-01-course-demo-page.png){ loading=lazy }
...
<figure markdown>
  ![The Demo Video panel. A red box and a red arrow point at the white play button on the video picture, which is titled as a demo lesson with the line Selected preview lesson from the actual course. Below it, a Demo access note explains what the demo includes](../assets/images/demo/demo-02-demo-video-panel.png){ loading=lazy }
...
<figure markdown>
  ![The video player with a red play button in the middle, outlined in red, and an arrow labelled Demo Video pointing at it](../assets/images/demo/demo-03-demo-video-player.png){ loading=lazy }
